...
writeLine:
          ...
          bne writeLine1
writeLine0:
          ldaa #LCD_LINE1 ; set cursor to begin of line 0
          bra  wDo
writeLine1:
          ldaa #LCD_LINE0 ; set cursor to begin of line 1
wDo:      jsr  outputByte
          
          jsr  sel_data   ; select data

msg_out:                  ; output the message character by character
          ldab #17        ; max. 16 characters + NUL otherwise only 16 characters will be shown
