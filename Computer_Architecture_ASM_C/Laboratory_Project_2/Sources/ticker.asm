...
TIMER_ON    equ %10000000       ; tscr1 value to turn ECT on, highest bit must be set 1 to enable Timer
...
.intVect: SECTION
        ORG $FFE6
int12:  DC.W isrECT4             ; Address from isrECT4 inserted in interrupt-vector. Called when interrupt happens.
...
initTicker:
        ...
        ldab TSCR2
        andb #$f8
        orab #7                 ; OR Bit operation with 0000 0111 between value of B and constant #7 change from #8 to #7 -> 2^7= 128
        stab TSCR2
...
isrECT4:
        ...
        movb #1, clockEvent     ; set clockEvent 1 
