...
#include <iostream>
using namespace std;
//erste Funktion funktioniert bereits, deshalb andere auskommentiert
//andere Funktionen mit int fallen Weg, da gleicher Übergabeparameter
//mit gleichem Übergabeparameter, funktioniert das Überladen nicht richtig
int function(int i_1)
{
    cout << "Funktion  1: i_1=" << i_1 << endl;
    return 0;
}
//void function nicht möglich, da bei c = function('a'); Rückgabewert erwartet wird
